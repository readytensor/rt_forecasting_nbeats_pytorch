# NBEATS Forecasting Model in PyTorch

NBEATS Forecasting Model in PyTorch as per Ready Tensor specifications.
...
- A **NBEATS Forecaster** algorithm built using **PyTorch**
